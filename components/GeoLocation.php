...
class GeoLocation {
  ...
  /**
   * [getEarthsRadius description]
   * @param  [type] $unit_of_measurement [description]
  ...
  /**
   * [MilesToKilometers description]
   * @param float $miles [description]
   */
  ...
  /**
   * [KilometersToMiles description]
   * @param float $km [description]
   */
