 ...
 * @var frenzelgmbh\cm-address\models\Post $model
 */
...
<fieldset class="fieldbodysc bg_white">
  <?php
    if(class_exists('frenzelgmbh\cm-address\widgets\PortletPostsSearch')){
      echo frenzelgmbh\cm-address\widgets\PortletPostsSearch::widget(array(
        'maxResults'=> 5,
        'title' => NULL
      ));
    }
...
<?php
  if(class_exists('\frenzelgmbh\cm-address\widgets\PortletPagination')){
    echo \frenzelgmbh\cm-address\widgets\PortletPagination::widget(array(
      'model'=>$model,
    )); 
  }
?>
